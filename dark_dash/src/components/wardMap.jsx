...
const WardMap = ({ datas, theme }) => {
  ...
  function findDensity(wardNo) {
    ...
    const paidHouses = totalDataOfWard.filter((entry) => {
      return (
        entry.Water_Tax > 0 && entry.Property_Tax > 0 && entry.Garbage_Tax > 0
      );
    }).length;
            ...
            <div style={{ width: "100%", height: "100vh" }}>
              ...
              >
                ...
                {geojsonData.features.map((state) => {
                  ...
                  const wardEntry = wardNumberData.filter(
                    (entry) => entry.region === wardName
                  );
                  ...
                  const fillColor = density
                    ? colorScale(density).hex()
                    : "black";
                    ...
                    <Polygon
                      ...
                      eventHandlers={{
                        mouseover: (e) => {
                          ...
                          layer
                            .bindTooltip(state.properties.name)
                            .openTooltip();
                        },
                        mouseout: (e) => {
                          const layer = e.target;
